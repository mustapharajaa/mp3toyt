...
export const ADMIN_CHANNELS_PATH = path.join(__dirname, '../admin_channels.json');
...
export const PENDING_AUTOMATION_PATH = path.join(__dirname, '../pending_automation.json');
